...
function WaPhone() {
  return (
    <div className="relative mx-auto w-full max-w-sm">
      <div className="absolute -left-6 top-10 hidden w-44 rounded-2xl border border-line bg-paper p-3 lg:block">
        <p className="font-serif text-2xl text-forest">4 fotos</p>
        <p className="mt-1 text-[11px] leading-snug text-ink-soft">Un PDF. Alta lista en la ficha.</p>
      </div>
      <div className="rounded-[2.2rem] border border-forest/15 bg-forest-deep p-3">
